...
当前稳定版本：[v0.1.11](https://github.com/1812095643/PLCpilot/releases/tag/v0.1.11)

- [Windows 安装版（EXE）](https://github.com/1812095643/PLCpilot/releases/download/v0.1.11/PLC-Pilot-0.1.11-x64-setup.exe)：适合大多数用户。
- [Windows 安装版（MSI）](https://github.com/1812095643/PLCpilot/releases/download/v0.1.11/PLC-Pilot-0.1.11-x64.msi)：适合组织化部署。
- [Windows 便携版（ZIP）](https://github.com/1812095643/PLCpilot/releases/download/v0.1.11/PLC-Pilot-Portable-0.1.11-win-x64.zip)：完整解压后运行，不写入系统 PATH。
- [CAREL STone MCP 独立包](https://github.com/1812095643/PLCpilot/releases/download/v0.1.11/PLC-Pilot-STone-MCP-0.1.1.zip)：需要单独运行 STone MCP 时使用。
- [更新清单](https://github.com/1812095643/PLCpilot/releases/download/v0.1.11/latest.json) · [SHA-256 校验](https://github.com/1812095643/PLCpilot/releases/download/v0.1.11/SHA256SUMS.txt)

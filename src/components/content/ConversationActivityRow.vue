...
.activity-heading { display:flex; align-items:center; gap:6px; width:100%; min-width:0; min-height:28px; padding:3px 0; border:0; background:transparent; color:var(--activity-muted); text-align:left; font-size:12px; line-height:20px; cursor:pointer; }
...
.activity-expansion-inner { min-height:0; overflow:hidden; }.activity-panel { margin:4px 1px 8px; border:1px solid var(--activity-edge); border-radius:10px; background:var(--activity-panel); color:var(--activity-text); overflow:hidden; }

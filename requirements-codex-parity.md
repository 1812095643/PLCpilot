...
> 编制日期：2026-09-03  
> 当前状态：仅记录需求，尚未实施；本次不得修改源码、配置、数据库或构建产物。

## 1. 来源与优先级

### 1.1 真实需求来源

本文件以用户在对话中发送的文字需求为验收依据。用户明确要求“先啥都别改”，因此本轮只交付本文件。
...
- 选中消息内容支持评论；评论需要保留选区文本、来源消息、文件/行号（若可定位）和评论正文。
...
- 本轮只新增本需求汇总文件。
- 未修改 Vue、TypeScript、Rust、Node、配置、数据库、插件、安装包或 `dist`。
- 未声称任何功能已经实现、构建通过或运行验证通过；后续实施必须逐项对照第 6 节验收清单。
